//
//  InternetCheckingController.swift
//  Workhub
//
...
class InternetCheckingController: BaseViewController {
    ...
    internal class func showAddOrClearPopUp(sourceViewController: UIViewController, alertMessage: String, didSubmit: @escaping ((_ text: String) -> ()), didFinish: @escaping (() -> ())) {
        ...
        let commentPopVC = mainStoryboard.instantiateViewController(withIdentifier: "InternetCheckingController") as! InternetCheckingController
    ...
    func presentAnimationToView(message: String) {
        ...
        if #available(iOS 10.0, *) {
            ...
            Timer.scheduledTimer(timeInterval: 4, target: self, selector: #selector(ToastController.dismissAnimate), userInfo: nil, repeats: false)
        }
    }
