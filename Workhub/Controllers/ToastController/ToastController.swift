...
class ToastController: BaseViewController {
    ...
    var didSubmitButton:((_ text: String, _ popUp: ToastController?) -> ())?
    var didRemove:(() -> ())?
    
    override func viewDidLoad() {
        super.viewDidLoad()
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(ToastController.tapDismissPopUp))
    ...
    internal class func showAddOrClearPopUp(sourceViewController: UIViewController, alertMessage: String, didSubmit: @escaping ((_ text: String, _ popUp: ToastController?) -> ()), didFinish: @escaping (() -> ())) {
