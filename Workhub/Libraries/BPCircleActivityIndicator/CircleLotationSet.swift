...
//        case .leftDown: return #colorLiteral(red: 0.2431372549, green: 0.3098039216, blue: 0.7058823529, alpha: 0.2003424658).cgColor
        ...
        case .leftUp: return UIColor (red: 255.0/255.0, green: 255.0/255.0, blue: 0.0/255.0, alpha: 1.0).cgColor
        case .rightUp: return UIColor (red: 255.0/255.0, green: 234.0/255.0, blue: 0.0/255.0, alpha: 1.0).cgColor
        case .rightDown: return UIColor (red: 255.0/255.0, green: 213.0/255.0, blue: 0.0/255.0, alpha: 1.0).cgColor
        case .leftDown: return UIColor (red: 255.0/255.0, green: 191.0/255.0, blue: 0.0/255.0, alpha: 1.0).cgColor
